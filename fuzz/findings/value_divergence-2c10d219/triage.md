# Triage: value_divergence-2c10d219

**BOTH SIDES COMPLETED — nothing to attribute at the process level**
...
## Side attribution (each side alone, in its own process)

| side | result | julia | first stderr line |
|---|---|---|---|
| reference (`Core.eval`) | ok in 0.8s | 1.12.6 | `` |
| interpreted (`rec`) | ok in 2.4s | 1.12.6 | `` |

## Newest installed Julia

No `julia +release` available (juliaup not on PATH?) — version check skipped.
